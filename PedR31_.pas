...
begin
  ...
  sBase := ' Select PedRe2.CodEmp,'+
           ...
           '        PedRe2.QtdFab,'+
           '        PedRe2.SldFab,'+
           '        TextoOcor(IntStrZeros(EstPro.CodCat,03),'+ QuotedStr('-') +',EstCat.NomCat,'+ QuotedStr('') +','+ QuotedStr('') +','+ QuotedStr('') +','+ QuotedStr('') +') as Categoria,'+
           '        TextoOcor(IntStrZeros(PedRes.CodCli,05),'+ QuotedStr('-') +',FinCli.ApeCli,'+ QuotedStr('') +','+ QuotedStr('') +','+ QuotedStr('') +','+ QuotedStr('') +') as NomCli,'+
           '        TextoOcor(PedRe2.CodGru,PedRe2.CodSub,PedRe2.CodPro,'+ QuotedStr('-') +',EstPro.DscPro,'+ QuotedStr('') +','+ QuotedStr('') +') as DscPro'+
...
procedure TfmPedR31.bPesquisaClick(Sender: TObject);
begin
  ...
  if EdPsqDtfRes1.Date > 0 then sFiltro := sFiltro + ' and PedRes.DtfRes >= '+ QuotedStr(fDateToSQL( EdPsqDtfRes1.Date ));
  if EdPsqDtfRes2.Date > 0 then sFiltro := sFiltro + ' and PedRes.DtfRes <= '+ QuotedStr(fDateToSQL( EdPsqDtfRes2.Date ));
...
procedure TfmPedR31.grResReloadGroupList(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqEmpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodEmpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if not ( key in [ '0'..'9' ] ) then key := #0;
end;

procedure TfmPedR31.BbPsqClpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodClpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqGruClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodGruExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqSubClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodSubExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqProClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodProExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqCliClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodCliExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.BbPsqVenClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodVenExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.bPsqCatClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodCatExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.bPsqTipClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodTipExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.bPsqMrcClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR31.EdCodMrcExit(Sender: TObject);
begin
  inherited;
...
begin
  ...
  try
     ...
     fmManCol.Synchronize(fmPedR31.grRes);
