inherited fmPedR20_CtaSint: TfmPedR20_CtaSint
  Left = 407
  Top = 139
  ...
  object PedR17: TQuery
    ...
    SQL.Strings = (
      ...
      ' cta.CodEmp,'
        ...
        ' ct2.CodClp || '#39'-'#39' || ct2.CodGru || '#39'.'#39' || ct2.CodSub || '#39'.'#39' || ' +
        'ct2.CodPro as CodIte,'
      ' pro.DscPro,'
      ' sum(coalesce(ct2.qtpct2,0.0)) as qtpct2,'
      ' sum(coalesce(re2.qtpre2,0.0)) as qtpre2,'
      ' sum(coalesce(lb2.ultqts,0.0)) as qtplb2,'
      
        ' sum(coalesce(lb2.SldLb2,0.0) + coalesce(ct2.QtnCt2,0.0)) as Sld' +
        'Lb2,'
      ' sum(coalesce(lb2.UltQts,0.0)) as UltQts,'
      ' sum(Round(ct2.vlqct2,4)) as VlqLb2,'
      
        ' sum(Round(((coalesce(lb2.SldLb2,0.0) + coalesce(ct2.QtnCt2,0.0)' +
      ...
      ' left join PedLib lib on lb2.codemp = lib.codemp '
      ' and lb2.dteres = lib.dteres '
      ' and lb2.numres = lib.numres '
      ' and lb2.seqlib = lib.seqlib '
      ...
      ' Where 1 <> 1'
        ...
        ' group by pedcta.CodEmp,pedct2.CodClp,pedct2.CodGru,pedct2.CodSu' +
        'b,pedct2.CodPro,estpro.dscpro '
      
        ' Order by pedcta.CodEmp,pedct2.CodClp,pedct2.CodGru,pedct2.CodSu' +
        'b,pedct2.CodPro,estpro.dscpro '
      ' ')
    Left = 232
    Top = 357
    ...
    object PedR17SLDLB2: TFloatField
      DisplayLabel = 'Qtd.Falta'
      FieldName = 'SLDLB2'
      DisplayFormat = '0.000'
      EditFormat = '0.000'
    end
    object PedR17ULTQTS: TFloatField
      DisplayLabel = 'Qtd.Separado'
      FieldName = 'ULTQTS'
      DisplayFormat = '0.000'
      EditFormat = '0.000'
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação Sintética de itens não atendidos'#13#10
      BandColor = clWhite
