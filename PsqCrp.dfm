  ...
  object FinCrp: TwwQuery
    ...
    SQL.Strings = (
      ...
      'From FinCrp INNER JOIN FinCre ON (FinCrp.CodEmp = FinCre.CodEmp)'
        ...
        'CodBan)'
      'Where FinCre.EmpOrc = :CodEmp'
      '     and FinCre.DteOrc = :DteRes'
      '     and FinCre.ResOrc = :NumRes'
      '     and FinCre.LibOrc = :SeqLib'
      '     and FinCre.SeqOrc = :SeqFat'
