inherited fmPedR27: TfmPedR27
  Left = 0
  Caption = 'Relação de Pedidos Aguardando Separação de Estoque'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grRes: TdxDBGrid
    ...
    object CLIENTE: TdxDBGridMaskColumn
      ...
      SummaryFooterFormat = 'Qtde Pedidos ####0'
    end
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           PedRe2.DteRes,'
        ...
        '           TextoOcor(PedRe2.CodGru,'#39'.'#39',PedRe2.CodSub,'#39'.'#39',PedRe2.' +
        'CodPro,'#39'-'#39',EstPro.DscPro) as Item,'
      '           PedRe2.QtpRe2'
      ...
      'Order by PedRe2.CodGru,PedRe2.CodSub,PedRe2.CodPro,PedRe2.NumRes')
    ...
    object PedResITEM: TStringField
      FieldName = 'ITEM'
      FixedChar = True
      Size = 100
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Pedidos Aguardando Separação de Estoque'#13#10#13#10
      BandColor = clWhite
