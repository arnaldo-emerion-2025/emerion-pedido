inherited fmPedR13: TfmPedR13
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           ApeVen,'
        ...
        '           TextoOcor(IntStrZeros(CodCli,05),'#39' - '#39',NomCli,'#39#39','#39#39','#39 +
        #39','#39#39') as Cliente,'
      '           PedLib.TotLib,'
      '           PedLib.BasCom,'
      '           PedLib.TotCom,'
      ...
      'From PedLib INNER JOIN PedRes ON (PedLib.CodEmp = PedRes.CodEmp)'
        ...
        '                         LEFT JOIN FinVen ON (PedRes.CodVen = Fi' +
        'nVen.CodVen)'
      
        '                            LEFT JOIN FinCli ON (PedRes.CodCli =' +
        ' FinCli.CodCli)'
      'Where PedRes.CodVen = :CodVen'
      '     and PedRes.ModPfa = '#39'Vendas'#39
      
        '     and (PedLib.SitLib = '#39'Faturado'#39' or PedLib.SitLib = '#39'Devolvi' +
        'do'#39')'
    ...
    object PedResSITLIB: TStringField
      FieldName = 'SITLIB'
      FixedChar = True
      Size = 45
    end
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Pedidos\DualComp\Relatorios\PedR13.rtm'
    Units = utMillimeters
    UserName = 'Report'
    DeviceType = 'Screen'
    Left = 304
    ...
    object ppHeaderBand: TppHeaderBand
      ...
      object ppLabel20: TppLabel
        UserName = 'QrTitulo1'
        Caption = 'Comercial - Resumo de Vendas por Vendedor (Analitico)'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Name = 'Tahoma'
        Font.Size = 10
