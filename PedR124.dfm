inherited fmPedR124: TfmPedR124
  Left = 343
  Top = 194
  ...
  object Label17: TLabel
    ...
    Width = 154
    Height = 13
    Caption = 'Programados para o Periodo de '
  ...
  object EdDtePrg1: TdxColorDateEdit
    Left = 178
    Top = 243
    Width = 87
    Color = 16577773
  ...
  object EdDtePrg2: TdxColorDateEdit
    Left = 290
    Top = 243
    Width = 87
    Color = 16577773
  ...
  object grRe2: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grRe2ReloadGroupList
    ...
    object grRe2Column11: TdxDBGridMaskColumn
      Caption = 'ID'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'IDEPRO'
    ...
    object grRe2Column12: TdxDBGridMaskColumn
      Caption = 'Referência'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'REFPRO'
    end
    object grRe2IPIRE2: TdxDBGridMaskColumn
      Caption = 'IPI'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'IPIRE2'
    end
    object grRe2ICMRE2: TdxDBGridMaskColumn
      Caption = 'ICMS'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'ICMRE2'
    end
    object grRe2CLSIPI: TdxDBGridMaskColumn
  ...
  object PedRe2: TwwQuery
    ...
    SQL.Strings = (
      ...
      'Round(PedRe2.VlqRe2 - PedRe2.VdrRe2,4) as VlqRe2,  '
        ...
        '(select idepro from estpro where codgru = PEDRE2.codgru and cods' +
        'ub = PEDRE2.codsub and codpro = PEDRE2.codpro and codclp = pedre' +
        '2.codclp)as IDEPRO,  '
      
        '(select refpro from estpro where and codgru = PEDRE2.codgru and ' +
        'codsub = PEDRE2.codsub and codpro = PEDRE2.codpro and codclp = p' +
        'edre2.codclp)as REFPRO,         '
      'pedre2.ipire2,        '
      'pedre2.icmre2,        '
      ...
      'and PedRe2.CodClp = '#39'1'#39' '
      'and PedRe2.CodGru = '#39'001'#39' '
      'and PedRe2.CodSub = '#39'0001'#39' '
      'and PedRe2.CodPro = '#39'00001'#39
      'and PedRe2.CodNcm = '#39'65000000'#39' '
      'and PedRes.SitRes <> '#39'Cancelado'#39' '
      'and PedRes.SitRes <> '#39'Rejeitado'#39)
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Perfil de Consumo - Pedidos'#13#10
      BandColor = clWhite
