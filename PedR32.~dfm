inherited fmPedR32: TfmPedR32
  ...
  object ckDevCan: TCheckBox
    Left = 104
    Top = 112
    Width = 201
    Height = 17
    Caption = 'Imprimir Devolução e Cancelamento'
    TabOrder = 8
  end
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      'Select'
      ' PedLib.NumRes, PedLib.DteRes, PedLib.DteFat, PedLib.CodVen,  '
      ...
      ' Cast(PedLib.NroNfs as varchar(10)) NroNfs, '
      
        ' PedLib.codcli, FinCli.nomcli,Finpgc.dtecre,Finpgc.vpppgc,PedLib' +
        '.TOTLIB TOTFAT '
      ' From PedLib '
      ' join FinCli on PedLib.codcli = FinCli.codcli '
      ' join Finpgc on finpgc.numcre = PedLib.nronfs '
      ' Where PedLib.CodVen  = :CodVen'
      ' Union All'
      
        ' Select LojPed.NumPed NumRes, LojPed.DtePed DteRes, LojPed.DopRp' +
        'e DteFat,  '
      ' LojPed.CodVen, LojPed.CodCli, '
      ' LojPed.NomCli, LojPed.TotPed TotLib,  LojPed.MedCom, '
      ' ((Finpgc.vpppgc*LojPed.BasCom)/lojped.totger)as Bascom, '
      ' ((Finpgc.vpppgc*LojPed.TotCom)/lojped.totger)as TOTCOM,  '
      ' Cast(LOJPED.NroNfs as varchar(10)) NroNfs, '
      
        ' LojPed.codcli, LojPed.nomcli,Finpgc.dtecre,Finpgc.vpppgc,LojPed' +
        '.TotPed TOTFAT  '
      ' From LojPed, Finpgc, LOJFAT '
      ' where LojPed.CodVen  = :CodVen'
      ' Union All'
      ' Select '
      ' PedLib.NumRes, PedLib.DteRes, PedLib.DteFat, PedLib.CodVen,  '
      ' PedLib.CodCli, FinCli.NomCli, '
      ...
      ' ((Finpgc.vpppgc*PedLib.TotCom)/pedlib.totger)as TOTCOM, '
        ...
        ' Cast(TRANSDOCL('#39'998'#39',PedLib.seqlib,PedLib.NUMRES) as varchar(10' +
        ')) NroNfs,'
      ...
      ' join FinCli on PedLib.codcli = FinCli.codcli '
        ...
        ' join Finpgc on TRANSDOCL('#39'998'#39',PedLib.seqlib,PedLib.NUMRES) = f' +
        'inpgc.numcre '
      '  Where PedLib.CodVen  = :CodVen')
    ...
    object PedResCODCLI_1: TIntegerField
      FieldName = 'CODCLI_1'
    end
    object PedResNOMCLI_1: TStringField
      FieldName = 'NOMCLI_1'
      Size = 70
    end
    ...
    object PedResVPPPGC: TFloatField
      FieldName = 'VPPPGC'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
