inherited fmPedR04: TfmPedR04
  Left = 0
  Caption = 'Relação simplificada de vendedores'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grVen: TdxDBGrid
    ...
    OnReloadGroupList = grVenReloadGroupList
    object grVenCODVEN: TdxDBGridMaskColumn
      Width = 76
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODVEN'
    end
    object grVenNOMVEN: TdxDBGridMaskColumn
      Width = 202
      BandIndex = 0
      RowIndex = 0
      FieldName = 'NOMVEN'
    end
    object grVenAPEVEN: TdxDBGridMaskColumn
      Width = 127
      BandIndex = 0
      RowIndex = 0
      FieldName = 'APEVEN'
    end
    object grVenCGCCPF: TdxDBGridMaskColumn
      Width = 96
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CGCCPF'
    end
    object grVenENDERECO: TdxDBGridMaskColumn
      Width = 369
      BandIndex = 0
      RowIndex = 0
      FieldName = 'ENDERECO'
    end
    object grVenCEPVEN: TdxDBGridColumn
      Caption = 'Cep'
      Width = 74
      BandIndex = 0
      RowIndex = 0
    ...
    object grVenTELEFONE: TdxDBGridMaskColumn
      Width = 108
      BandIndex = 0
      RowIndex = 0
      FieldName = 'TELEFONE'
  ...
  object EdPsqCodGve: TdxColorEdit
    ...
    OnKeyPress = EdPsqCodGveKeyPress
  ...
  object FinVen: TwwQuery
    ...
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select CodVen,NomVen,ApeVen,CepVen,'
      '           FormatCgcCpf(CgcVen) as CgcCpf,'
      
        '           Endereco(TenVen,EndVen,NumVen,RefVen,BaiVen,CidVen,Si' +
        'gUfe) as Endereco,'
      
        '           TextoOcor('#39'('#39',PrfVen,'#39')'#39','#39' '#39',FonVen,'#39#39','#39#39') as Telefon' +
        'e'
      'From FinVen'
      'Where CodVen = :CodVen'
      'Order by CodVen')
    ...
    object FinVenNOMVEN: TStringField
      DisplayLabel = 'Nome'
      FieldName = 'NOMVEN'
      FixedChar = True
      Size = 40
    ...
    object FinVenCGCCPF: TStringField
      DisplayLabel = 'CNPJ/CPF'
      FieldName = 'CGCCPF'
      FixedChar = True
      Size = 18
    end
    object FinVenENDERECO: TStringField
      DisplayLabel = 'Endereço'
      FieldName = 'ENDERECO'
      FixedChar = True
      Size = 172
    end
    object FinVenTELEFONE: TStringField
      DisplayLabel = 'Telefone'
      FieldName = 'TELEFONE'
      FixedChar = True
      Size = 100
    end
    object FinVenCEPVEN: TStringField
      FieldName = 'CEPVEN'
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      PrinterPage.Margins.Right = 10600
      PrinterPage.Margins.Top = 34400
      ...
      ReportTitle.Text = #13#10'Relação simplificada de vendedores'#13#10#13#10
      BandColor = clWhite
