...
uses
  ...
  ManImpPedNovo in 'ManImpPedNovo.pas' {fmManImpPedNovo},
  ManImpCtaNovo in 'ManImpCtaNovo.pas' {fmManImpCtaNovo},
  ManImpCtaReduz in 'ManImpCtaReduz.pas' {fmManImpCtaReduz},
  PedR24 in 'PedR24.pas' {fmPedR24},
  PsqEs3 in 'PsqEs3.pas' {fmPsqEs3},
  PedR20_Cta in 'PedR20_Cta.pas' {fmPedR20_Cta},
  PedR20_CtaSint in 'PedR20_CtaSint.pas' {fmPedR20_CtaSint},
  ManImpCtaNovoSemDesc_Red in 'ManImpCtaNovoSemDesc_Red.pas' {fmManImpCtaNovoSemDesc_Red},
  ManE03_1 in 'ManE03_1.pas' {fmManE03_1},
  PsqHre in 'PsqHre.pas' {fmPsqHre},
  ManAltLimCli in '..\..\financeiro\emerion\ManAltLimCli.pas' {fmAltLimCli},
  manHistCliDev in '..\..\financeiro\emerion\manHistCliDev.pas' {fmManHistCliDev},
