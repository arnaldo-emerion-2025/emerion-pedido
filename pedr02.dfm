inherited fmPedR02: TfmPedR02
  Left = 0
  Caption = 'Relação de Itens em Promoção'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object bPsqPrm: TSpeedButton
    Left = 250
    Top = 16
    Width = 23
    Height = 21
    Hint = 'Pesquisar Promoções Existentes'
    Flat = True
    Glyph.Data = {
  ...
  object grPrm: TdxDBGrid
    ...
    OnReloadGroupList = grPrmReloadGroupList
    object grPrmNOMPRM: TdxDBGridMaskColumn
      Sorted = csUp
      Visible = False
      Width = 1438
      BandIndex = 0
    ...
    object grPrmDSCPRO: TdxDBGridMaskColumn
      Width = 235
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DSCPRO'
    end
    object grPrmDS1PR2: TdxDBGridColumn
    ...
    object grPrmQT1PR2: TdxDBGridColumn
    ...
    object grPrmDS2PR2: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 77
      BandIndex = 0
      RowIndex = 0
    ...
    object grPrmQT2PR2: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Qtd'
      HeaderAlignment = taRightJustify
      Width = 69
    ...
    object grPrmDS3PR2: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 78
      BandIndex = 0
      RowIndex = 0
    ...
    object grPrmQT3PR2: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Qtd'
      HeaderAlignment = taRightJustify
      Width = 71
    ...
    object grPrmDS4PR2: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 85
      BandIndex = 0
      RowIndex = 0
    ...
    object grPrmQT4PR2: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Qtd'
      HeaderAlignment = taRightJustify
      Width = 74
    ...
    object grPrmDS5PR2: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 88
      BandIndex = 0
      RowIndex = 0
    ...
    object grPrmQT5PR2: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Qtd'
      HeaderAlignment = taRightJustify
      Width = 73
  ...
  object PedPrm: TwwQuery
    ...
    SQL.Strings = (
        ...
        'Select TextoOcor(NOMPRM,'#39'PERIODO DE'#39',DATETOSTR(CAST(CAST(DTIPRM ' +
        'AS DATE) AS CHAR(12))),'#39'A'#39',DATETOSTR(CAST(CAST(DTFPRM AS DATE) A' +
        'S CHAR(12))),'#39#39','#39#39') as NomPrm,'
      
        '           TextoOcor(CODGRU,'#39'.'#39',CODSUB,'#39'.'#39',CODPRO,'#39'-'#39',DSCPRO) as' +
        ' DscPro,'
      '           Ds1Pr2,'
      '           Qt1Pr2,'
      '           Ds2Pr2,'
      ...
      '     and PedPrm.CodPrm = :CodPrm'
      'Order by PedPr2.CodGru,PedPr2.CodSub,PedPr2.CodPro')
    ...
    object PedPrmNOMPRM: TStringField
      DisplayLabel = 'Promoção'
      FieldName = 'NOMPRM'
      FixedChar = True
      Size = 100
    end
    object PedPrmDSCPRO: TStringField
      DisplayLabel = 'Item'
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 100
    end
    object PedPrmDS1PR2: TFloatField
      DisplayLabel = 'Tabela 1'
      FieldName = 'DS1PR2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedPrmQT1PR2: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'QT1PR2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object PedPrmDS2PR2: TFloatField
      DisplayLabel = 'Tabela 2'
      FieldName = 'DS2PR2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedPrmQT2PR2: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'QT2PR2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object PedPrmDS3PR2: TFloatField
      DisplayLabel = 'Tabela 3'
      FieldName = 'DS3PR2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedPrmQT3PR2: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'QT3PR2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object PedPrmDS4PR2: TFloatField
      DisplayLabel = 'Tabela 4'
      FieldName = 'DS4PR2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedPrmQT4PR2: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'QT4PR2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object PedPrmDS5PR2: TFloatField
      DisplayLabel = 'Tabela 5'
      FieldName = 'DS5PR2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedPrmQT5PR2: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'QT5PR2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Comercial - Relação de Itens em Promoção'#13#10#13#10
      BandColor = clWhite
